(function(){
  ...
  function failureHint(){
    ...
    if (localFile())
      return "مرورگر به صفحه‌ای که از روی فایل باز شده اجازه اتصال نمی‌دهد — " +
             "این محدودیت روی گوشی سخت‌گیرانه‌تر است. صفحه را از یک آدرس اینترنتی باز کنید " +
             "یا نرخ‌ها را دستی وارد کنید.";
    return "مرورگر اجازه هیچ اتصال بیرونی نداد — اگر صفحه را از لینک باز کرده‌اید، " +
           "نسخه میزبانی‌شده این محدودیت را ندارد. تا آن موقع نرخ‌ها را دستی وارد کنید.";
  }
  var showDiag = false;
